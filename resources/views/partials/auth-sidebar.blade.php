 <div class="wrap-sidebar-account">
     <div class="sidebar-account">
         <div class="account-avatar">
             <div class="image">
                 <img src="{{ auth()->user()->avatar ?? asset('theme/images/avatar/avatar-3.jpg') }}" alt="user avatar">
             </div>
         ...
         <ul class="my-account-nav">
             <li>
                 <a href="{{ route('my-account.index') }}"
                     class="my-account-nav-item {{ request()->routeIs('my-account.index') ? 'active' : '' }}">
             ...
             <li>
                 <a href="{{ route('my-account.orders.index') }}"
                     class="my-account-nav-item {{ request()->routeIs('my-account.orders*') ? 'active' : '' }}">
                     <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                         xmlns="http://www.w3.org/2000/svg">
                         <path
             ...
             <li>
                 <a href="{{ route('my-account.address') }}"
                     class="my-account-nav-item {{ request()->routeIs('my-account.address*') ? 'active' : '' }}">
                     <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                         xmlns="http://www.w3.org/2000/svg">
                         <path
