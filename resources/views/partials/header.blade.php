                        ...
                        <ul class="box-nav-ul justify-content-start">
                            @foreach (menues() as $menu)
                                ...
                                @if ($menu['title'] === 'Products')
                                            ...
                                            <div class="container">
                                                <div class="row-demo-1">
                                                    <div class="mega-menu-list">
                                                                ...
                                                                <ul class="menu-list">
                                                                    @foreach ($category['items'] as $item)
                                                                        <li
                                                                            ...
                                                                            <a href="{{ route('products.index', ['type' => $category['type'], 'category' => $item['category']]) }}"
                                                                                class="menu-link-card menu-link-text text_secondary link">
                                                        ...
                                                        @endforeach
                                                        <button class="text-title text-uppercase close">close</button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <!--  -->
                                @elseif ($menu['title'] === 'Planning Tools')
                                    <li class="menu-item planning">
                                        <a href="javascript:void(0)"
                                            class="item-link text-uppercase">{{ $menu['title'] }}<i
                                                class="icon icon-down"></i></a>
                                        <div class="sub-menu mega-menu mega-menu-1">
