                         ...
                         <div class="swiper-wrapper">
                             @foreach ($categories as $category)
                                 @php
                                     ...
                                     if ($category['slug'] === 'commercial-play-equipment') {
                                         $title = 'Commercial Play';
                                     } elseif ($category['slug'] === 'accessories-replacement-parts') {
                                         $title = 'Accessories & Parts';
                                     } elseif ($category['slug'] === 'safety-surfacing-edging') {
                                         $title = 'Surfacing & Edging';
                                     }
                                 @endphp
                                 <div class="categories-item wow fadeInUp swiper-slide"
                                     ...
                                     <div class="content">
                                         <h5 class="title" style="font-size: 18px;"><a
                                                 href="{{ route('categories.show', $category['slug']) }}"
                                                 class="link">{{ $title }}</a></h5>
