                            ...
                            <div class="card card-flush py-4">
                                ...
                                <div class="card-body pt-0">
                                    ...
                                    <div>
                                        ...
                                        {{ old('description', $product->description_html) }}</textarea>
                                        @error('description')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    ...
                                    <div class="mt-3">
                                        ...
                                        <textarea name="seo_description" class="form-control mb-2 @error('seo_description') is-invalid @enderror">{{ old('seo_description', $product->description) }}</textarea>
                                        @error('seo_description')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                        <div class="text-muted fs-7">Set a description to the product for search engines to
                                            better understand the product. Max 160 characters. Include keywords as well you
                                            want to rank for this product.
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card card-flush py-4">
                                ...
                                <div class="card-body pt-0">
                                    <div class="fv-row mb-2">
                                        ...
                                        @livewire('admin.product-images', ['product' => $product ?? null])
                                    </div>
                                ...
                                <div class="card-body pt-0">
                                    <div class="mb-10 fv-row">
                                        ...
                                        <select class="form-select mb-2 text-capitalize @error('type') is-invalid @enderror"
                                            ...
                                            @foreach ($types as $item)
                                                <option value="{{ $item }}" @selected($item == old('type', $product->type))>
                                    ...
                                    <div class="mb-10 fv-row">
                                        ...
                                        <select
                                            ...
                                            @foreach ($categories as $item)
                                                <option value="{{ $item }}" @selected($item == old('category', $product->category))>
                                                    {{ ucwords(str_replace('-', ' ', $item)) }}</option>
                                            @endforeach
                                        </select>
                                        @error('category')
                                    ...
                                    <div class="mb-10 fv-row">
                                        ...
                                        <select
                                            ...
                                            {{-- data-hide-search="true" data-placeholder="Select product sub category" --}}
                                            <option value="">None</option>
                                            @foreach ($sub_categories as $item)
                                                <option value="{{ $item }}" @selected($item == old('sub_category', $product->sub_category))>
                                                    {{ ucwords(str_replace('-', ' ', $item)) }}</option>
                                            @endforeach
                                        </select>
                                        @error('sub_category')
                                    ...
                                    <div class="mb-10 fv-row">
                                        ...
                                        <input type="text" name="sku"
                                            ...
                                            placeholder="SKU Number" value="{{ old('sku', $product->sku) }}" />
                                        @error('sku')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    ...
                                    <div class="mb-10 fv-row">
                                        ...
                                        <select class="form-select mb-2 @error('age_group') is-invalid @enderror"
                                            ...
                                            @foreach ($age_groups as $group)
                                                <option value="{{ $group }}" @selected($group == old('age_group', $product->age_group))>
                                                    {{ $group }}</option>
                                            @endforeach
                                        </select>
                                        @error('age_group')
                                    ...
                                    <div class="mb-10 fv-row">
                                        ...
                                        <input type="text" name="min_capacity"
                                            ...
                                            value="{{ old('min_capacity', $product->min_capacity) }}" />
                                        @error('min_capacity')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    ...
                                    <div class="mb-10 fv-row">
                                        ...
                                        <input type="text" name="playground_series"
                                            ...
                                            placeholder="Playground Series"
                                            value="{{ old('playground_series', $product->playground_series) }}" />
                                    ...
                                    <div class="mb-10 fv-row">
                                        ...
                                        <input type="text" name="recycled_content"
                                            ...
                                            value="{{ old('recycled_content', $product->recycled_content) }}" />
                                    ...
                                    <div class="mb-10 fv-row">
                                        ...
                                        <select class="form-select mb-2 @error('quick_ship_item') is-invalid @enderror"
                                            ...
                                            @foreach ($quickShips as $item)
                                                <option value="{{ $item }}" @selected($item == old('quick_ship_item', $product->quick_ship_item))>
                                                    {{ $item }}</option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="mb-10 fv-row">
                                        ...
                                        <select
                                            ...
                                            @foreach ($status as $item)
                                                <option value="{{ $item['value'] }}" @selected($item['value'] == old('status', $product->status))>
                                                    {{ $item['label'] }}</option>
                                            @endforeach
                                        </select>
                                        @error('status')
